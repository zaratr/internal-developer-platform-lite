...
- **Service template generator**: `idp create service <name>` scaffolds a FastAPI backend that already has health checks, logging, metrics hooks, and config conventions.
...
- **Multi-language support**: The template generator is language-agnostic; adding a Go template is a matter of extending `TEMPLATES`.
